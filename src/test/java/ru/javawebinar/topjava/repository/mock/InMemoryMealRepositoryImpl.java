...
import static ru.javawebinar.topjava.UserTestData.userId;
...
public class InMemoryMealRepositoryImpl implements MealRepository {
    ...
    {
        MealsUtil.MEALS.forEach(um -> save(um, userId));

        save(new Meal(LocalDateTime.of(2015, Month.JUNE, 1, 14, 0), "Админ ланч", 510), adminId);
        save(new Meal(LocalDateTime.of(2015, Month.JUNE, 1, 21, 0), "Админ ужин", 1500), adminId);
    }
