...
public class MealRestController extends AbstractMealController {
  ...
  /*  @PostMapping(value = "/filter", consumes = MediaType.APPLICATION_JSON_VALUE
            , produces = MediaType.APPLICATION_JSON_VALUE)
    public List<MealWithExceed> getBetween(@RequestBody FilterForm filterForm) {
        return super.getBetween(filterForm.startDate, filterForm.startTime, filterForm.endDate, filterForm.endTime);
    }*/
